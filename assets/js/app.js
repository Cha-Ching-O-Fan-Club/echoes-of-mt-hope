import * as sites from './load-sites.js';

const unfoundSitesContainer = document.getElementById('unfound-sites-list');
const foundSitesContainer = document.getElementById('found-sites-list');
...
function markClueCompleted() {
    sites.loadUnfoundSites(unfoundSitesContainer);
    sites.loadFoundSites(foundSitesContainer);
